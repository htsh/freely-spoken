...
_VOCAB_PATH = os.path.join(
    ...
    "..", "..", "openspec", "changes", "dhammapada-catalog-lookup", "vocabulary.json",
)
...
def test_crisis_predicate_matches_frozen_vocabulary():
    ...
    bump cannot silently desync the runtime filter from the labels (4.6)."""
...
def test_crisis_eligible_count_is_stable():
    """Guards the 260-eligible figure the plan and human review signed off on.
