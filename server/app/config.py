...
_DEFAULT_ORDER = ["groq", "cerebras", "mistral", "cloudflare", "openrouter", "cohere", "together", "nvidia", "huggingface"]
...
def load() -> Settings:
    return Settings(
        ...
        provider_timeouts=_parse_provider_timeouts(
            os.getenv("LOOKUP_PROVIDER_TIMEOUTS", "nvidia:15,openrouter:15,cohere:20,cloudflare:15,together:15,huggingface:30")
        ),
