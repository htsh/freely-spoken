...
Development-only data-prep tool. Parses the canonical F. Max Müller
...
left empty for the LLM labeling pass to fill.
...
# Provenance constants for the public-domain source text.
