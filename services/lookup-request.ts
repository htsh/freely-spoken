...
// recording duration, or device identifier is ever part of this shape — see the
// privacy boundary in CLAUDE.md. buildLookupRequest below whitelists each field
